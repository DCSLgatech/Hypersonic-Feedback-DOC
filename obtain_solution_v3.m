function solution = obtain_solution_v3(alpha, C, IC, FC, LB, UB, ND)
...
nominal_loader  = load('nominal_solution');
...
setup.functions.continuous           = @Hypersonic_Continuous_v3;
setup.functions.endpoint             = @Hypersonic_Endpoint_v3;
