function solution = obtain_solution_v3_DOC(alpha, C, IC, FC, LB, UB, ND)
...
bounds.phase.initialstate.lower = [IC.rbar, IC.phi, IC.vbar, IC.fpa, IC.Svec];
bounds.phase.initialstate.upper = [IC.rbar, IC.phi, IC.vbar, IC.fpa, IC.Svec];

% State bounds
bounds.phase.state.lower = [LB.rbar, LB.phi, LB.vbar, LB.fpa, LB.Svec];                        
bounds.phase.state.upper = [UB.rbar, UB.phi, UB.vbar, UB.fpa, UB.Svec];
                        
% Final state bounds
bounds.phase.finalstate.lower = [FC.rbar, FC.phiMin, FC.vbar, FC.fpaMin, LB.Svec];
bounds.phase.finalstate.upper = [FC.rbar, FC.phiMax, FC.vbar, FC.fpaMax, UB.Svec];
...
nominal_loader  = load('doc_solution');
nominal         = nominal_loader.solution;
...
setup.functions.continuous           = @Hypersonic_Continuous_v3_DOC;
setup.functions.endpoint             = @Hypersonic_Endpoint_v3_DOC;
