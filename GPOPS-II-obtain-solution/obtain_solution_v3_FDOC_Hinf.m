function solution = obtain_solution_v3_FDOC_Hinf(alpha, gamma, C, IC, FC, LB, UB, ND)
...
setup.functions.continuous           = @Hypersonic_Continuous_FDOC_Hinf;
setup.functions.endpoint             = @Hypersonic_Endpoint_v3_FDOC_Hinf;
